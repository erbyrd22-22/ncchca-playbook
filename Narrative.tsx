...
/**
 * Assembles a grant-report draft from whatever is actually on file, and is
 * explicit about what is still missing rather than inventing it. The gaps
 * are the point: they tell you what to go collect before the report is due.
 */
    ...
    <>
      {gaps.length > 0 && (
        <div className="note">
          ...
          <div>
            The draft below marks these in brackets rather than guessing:{' '}
